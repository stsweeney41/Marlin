...
#define Z_AFTER_PROBING           100 // (mm) Z position after probing is done
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 60, 60, 238, 290 } // (mm) Left, Front, Right, Back insets
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_Z_FEEDRATE   14   // (mm/s) Z axis feedrate (not used for delta printers)
#endif
